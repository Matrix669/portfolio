...
import GOOGLEPAY_IMG from '@/assets/formSupport/google-pay.png'
import APPLEPAY_IMG from '@/assets/formSupport/apple-pay.png'
import PAYPAL_IMG from '@/assets/formSupport/paypal.png'
import PRZELEWY24_IMG from '@/assets/formSupport/przelewy24.png'
