export default function TrashIcon() {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
			<g clipPath='url(#clip0_447_2775)'>
				<path d='M4 7H20' stroke='#F75C4F' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M10 11V17' stroke='#F75C4F' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M14 11V17' stroke='#F75C4F' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				<path
