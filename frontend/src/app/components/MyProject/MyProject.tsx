...
import MyProjectScrollReveal from '@/app/UI/MyProjectScrollReveal/MyProjectScrollReveal'
...
export default async function MyProject({ project, index }: { project: LocalizedProject; index: number }) {
	...
	return (
		<article key={project.id}>
			<MyProjectScrollReveal fromXEven={isEvenItem ? -150 : 150}>
